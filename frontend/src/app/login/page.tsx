...
export default function Login() {
	...
	const [logIn, { data, loading, error }] = useMutation(LOG_IN, {
		onCompleted: (data) => {
			if (data == null || data.login == null) return createError(['email'], 'An error has occurred');
			let authKey = data.login.auth_key;
	...
	return (
		<div className='w-full flex h-full justify-center items-center flex-col pb-[80px]'>
			<div className='py-3 bg-gray-200 w-[400px] h-min rounded shadow-md font-sans flex flex-col items-center'>
				<div className='text-black text-4xl w-full flex justify-center items-center text-center py-2 mb-1'>Log in</div>
